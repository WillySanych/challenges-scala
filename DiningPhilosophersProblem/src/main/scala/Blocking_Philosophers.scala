...
import Blocking_Philosophers._
import Forks.forks

class Blocking_Philosophers(ctx: ActorContext[Actions],
                            name: String,
                            leftFork: Int,
                            rightFork: Int) {
...
object Blocking_Philosophers {
  ...
  def apply(name: String,
    ...
    new Blocking_Philosophers(ctx, name, leftFork, rightFork).thinks()
  }
